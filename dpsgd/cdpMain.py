...
from dpsgd.cdpSanitizer import *
...
def main():
        ...
        for step in range(1, n_steps + 1):
            ...
            if USE_PRIVACY:
                ...
                for px_grad in gradients:
                    ep = 1
                    sens = (2 * L2NORM_BOUND) / BATCH_SIZE
                    lower = -2
                    index = 1
                    sanitized_grad = sanitizer.sanitize(px_grad, eps_delta, ep, sens, lower, index)
    ...
    # Save model
    version = "CDP" if USE_PRIVACY else "SGD"
